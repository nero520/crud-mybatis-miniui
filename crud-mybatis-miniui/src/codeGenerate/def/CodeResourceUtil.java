...
public class CodeResourceUtil {
	...
	public static String viewPackage = "sun";
	public static String viewPackageUrl = "sun";

	public static String entity_package = "entity";

	public static String page_package = "page";

	public static String ENTITY_URL = source_root_package + "/"
			+ bussiPackageUrl + "/" + entity_package + "/";

	public static String PAGE_URL = source_root_package + "/" + bussiPackageUrl
			+ "/" + page_package + "/";
	...
	private static String getViewPackage() {
		return bundlePath.getString("view_package");
	}
